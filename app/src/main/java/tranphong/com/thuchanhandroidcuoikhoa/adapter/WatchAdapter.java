...
public class WatchAdapter extends BaseAdapter {
    ...
    public WatchAdapter(WatchActivity context, int layout, List<Product> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        WatchAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new WatchAdapter.ViewHolder();
