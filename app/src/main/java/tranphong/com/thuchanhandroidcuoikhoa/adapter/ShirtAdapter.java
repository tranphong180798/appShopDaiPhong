...
public class ShirtAdapter extends BaseAdapter {
    int x = 0;
    private ShirtActivity context;
    private int layout;
    private List<Product> arraListProduct;

    public ShirtAdapter(ShirtActivity context, int layout, List<Product> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ShirtAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new ShirtAdapter.ViewHolder();
