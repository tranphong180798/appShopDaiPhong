...
public class ShoesAdapter extends BaseAdapter {
    int x = 0;
    private ShoesActivity context;
    private int layout;
    private List<Product> arraListProduct;

    public ShoesAdapter(ShoesActivity context, int layout, List<Product> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ShoesAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new ShoesAdapter.ViewHolder();
