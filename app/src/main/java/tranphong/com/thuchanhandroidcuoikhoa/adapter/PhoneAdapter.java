...
public class PhoneAdapter extends BaseAdapter {
    int x = 0;
    private SmartPhoneActivity context;
    private int layout;
    private List<Product> arraListProduct;

    public PhoneAdapter(SmartPhoneActivity context, int layout, List<Product> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        PhoneAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new PhoneAdapter.ViewHolder();
