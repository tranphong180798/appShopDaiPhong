...
import tranphong.com.thuchanhandroidcuoikhoa.adapter.CommentAdapter;
...
import tranphong.com.thuchanhandroidcuoikhoa.model.User;
...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewMuiTen.setImageResource(R.mipmap.muiten);
        imagegiohang.setImageResource(R.mipmap.giohang);
                ...
                if (response != null){
                    for (int i = 0; i < response.length(); i++){
                        try {
                            ...
                            commentArrayList.add(new Comment(id,username,tensanpham,content));
    ...
    private void GetDataProductDetail() {
        ...
        Picasso.with(getApplicationContext()).load(image).into(imageViewProductDetail);
        ...
        imghinhne.setImageResource(R.mipmap.caybut);
        imgbinhluanUser.setImageResource(R.mipmap.comment);
    ...
    private void init() {
        ...
        commentAdapter=new CommentAdapter(this,R.layout.dong_binh_luan,commentArrayListFilter);
